...
describe('Receitas e despesas', () => {
  ...
  it('Adição de uma receita/despesa', () => {
  ...
  it('Edição de uma receita/despesa', () => {
  ...
  it('Validação doos valores do gráfico', () => {
  ...
  it('Validação do download do balancete', () => {
  ...
  it('Pesquisa de receita/despesa específica', () => {
